...
This webpage contains R codes used for Shin et al. (in press). Data and scripts used for text preprocessing were also posted through an online data repository at [https://doi.org/10.17605/OSF.IO/8CNYW](https://doi.org/10.17605/OSF.IO/8CNYW). 
